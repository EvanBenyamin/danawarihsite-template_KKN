      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="carousel-caption d-md-block" style="margin-bottom: 140px;">
            <h1 style="
  -webkit-text-stroke-width: 1px;background-color: gray; width: 700px;margin-left:260px;
  -webkit-text-stroke-color: black; opacity: 0.8;)">Welcome to Desa Danawarih</h1>
          ...
          <img class="img-slide" style="width:100vw; height:100vh;filter:brightness(60%)" src="<?=base_url()?>assets/img/danawarih.jpg" alt="First slide">
        </div>
